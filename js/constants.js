...
const	PLAYER_CHECKPLACE= 'Checking...';
const	PLAYER_LOSE	= 'Oh no, you have lost!';
...
const COLOR_DARKGRAY= 0x3f3c38;
const COLOR_BLOCKS  = [ COLOR_RED, COLOR_GREEN, COLOR_BLUE, COLOR_YELLOW ];

const FINAL_SENTENCE1 = "[ACTIVE] has made a wrong move and the tower master has drop him out from Kujenga Pamoja hall of fame.<br/><br/>Anyway, you have made it up to [FLOOR] floors. <br/><br/>You think you can beat this mark? Let's see what you got!";
const FINAL_SENTENCE2 = "[ACTIVE] I think you need a little practice to beat [FLOOR] floors.<br/><br/>What do you think? It's building time so let's do it!";
const FINAL_SENTENCE3 = "Great!! You might be proud of reaching [FLOOR] floors, but that's not a mark for true Kujenga warriors. <br/><br/>Do you have what it takes? So play again and beat your mark!";
